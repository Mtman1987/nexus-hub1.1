...
export const ALL_MODULES_CONFIG = [
    { id: 'unifiedChat', title: 'Unified Chat', component: UnifiedChat, defaultSize: 'col-span-1 md:col-span-2 xl:col-span-3', icon: MessageSquare },
    ...
    { id: 'logViewer', title: 'Captain\'s Log', component: LogViewer, defaultSize: 'col-span-1 md:col-span-2', icon: BookText },
