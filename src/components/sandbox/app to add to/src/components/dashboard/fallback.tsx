...
import { Loader2, Wand2, GripVertical, EyeOff, Code, Copy } from 'lucide-react';
...
export function Fallback({ onPopOut, isPoppedOut = false, onHide, dragHandleProps, isPreview }: CodeHelperProps) {
