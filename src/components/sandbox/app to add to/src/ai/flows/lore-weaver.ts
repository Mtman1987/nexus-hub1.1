...
IMPORTANT: Generate a helpful and creative response. The final transmission must be a valid JSON object with a single key: "response". Do not add any other text or formatting.`;
